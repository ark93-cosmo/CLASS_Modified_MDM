...
struct perturbs
{
 ...
 int size_tensor_perturbation_data[_MAX_NUMBER_OF_K_FILES_]; /**< Array of sizes of tensor double pointers  */
  ...
  short has_source_delta_mimetic;  /**< do we need source for delta of mimetic? */
  ...
  short has_source_theta_mimetic;  /**< do we need source for theta of cold dark matter? */
  ...
  int index_tp_delta_mimetic; /**< index value for delta of mimetic field */
  ...
  int index_tp_theta_mimetic;  /**< index value for theta of mimetic field */
  ...
  double analytic_mimetic_percent;
  double rand_mimetic_percent;
  //@}
...
struct perturb_vector
{
  ...
  int index_pt_delta_mimetic; /**< mimetic field density */
  int index_pt_theta_mimetic; /**< mimetic field velocity */
